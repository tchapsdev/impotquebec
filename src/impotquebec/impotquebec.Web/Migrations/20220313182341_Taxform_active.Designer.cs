...
namespace Tchaps.Impotquebec.Migrations
{
    ...
    [Migration("20220313182341_Taxform_active")]
    partial class Taxform_active
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tchaps.Impotquebec.Models.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tchaps.Impotquebec.Models.AppUserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tchaps.Impotquebec.Models.DeclarationDetail", b =>
                {
                    b.Property<int>("DeclarationDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DeclarationDetailId"), 1L, 1);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Tchaps.Impotquebec.Models.AppUserRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Tchaps.Impotquebec.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tchaps.Impotquebec.Models.Declaration", b =>
                {
                    ...
                    b.HasOne("Tchaps.Impotquebec.Models.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
