...
namespace impotquebec.Web.Areas.Admin.Controllers
{
    ...
    public class TaxFormSectionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TaxFormSectionId,TaxFormId,InternalName,LineNumbers,Name,Description")] TaxFormSection taxFormSection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TaxFormSectionId,TaxFormId,InternalName,LineNumbers,Name,Description")] TaxFormSection taxFormSection)
        {
